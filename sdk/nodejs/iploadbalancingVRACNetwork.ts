 ...
 */
export class IPLoadbalancingVRACNetwork extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: IPLoadbalancingVRACNetworkState, opts?: pulumi.CustomResourceOptions): IPLoadbalancingVRACNetwork {
        return new IPLoadbalancingVRACNetwork(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'ovh:index/iPLoadbalancingVRACNetwork:IPLoadbalancingVRACNetwork';

    /**
     * Returns true if the given object is an instance of IPLoadbalancingVRACNetwork.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is IPLoadbalancingVRACNetwork {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === IPLoadbalancingVRACNetwork.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: IPLoadbalancingVRACNetworkArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: IPLoadbalancingVRACNetworkArgs | IPLoadbalancingVRACNetworkState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as IPLoadbalancingVRACNetworkState | undefined;
            ...
            const args = argsOrState as IPLoadbalancingVRACNetworkArgs | undefined;
        ...
        super(IPLoadbalancingVRACNetwork.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface IPLoadbalancingVRACNetworkState {
    /**
     * Human readable name for your vrack network
     */
 ...
 */
export interface IPLoadbalancingVRACNetworkArgs {
    /**
     * Human readable name for your vrack network
     */
    displayName?: pulumi.Input<string>;
