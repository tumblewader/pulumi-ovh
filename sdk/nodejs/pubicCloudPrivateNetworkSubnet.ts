 ...
 * ```
 */
export class PubicCloudPrivateNetworkSubnet extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PubicCloudPrivateNetworkSubnetState, opts?: pulumi.CustomResourceOptions): PubicCloudPrivateNetworkSubnet {
        return new PubicCloudPrivateNetworkSubnet(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'ovh:index/pubicCloudPrivateNetworkSubnet:PubicCloudPrivateNetworkSubnet';

    /**
     * Returns true if the given object is an instance of PubicCloudPrivateNetworkSubnet.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is PubicCloudPrivateNetworkSubnet {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === PubicCloudPrivateNetworkSubnet.__pulumiType;
    }
     ...
     */
    public /*out*/ readonly ipPools!: pulumi.Output<outputs.PubicCloudPrivateNetworkSubnetIpPool[]>;
    /**
     ...
     */
    constructor(name: string, args: PubicCloudPrivateNetworkSubnetArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: PubicCloudPrivateNetworkSubnetArgs | PubicCloudPrivateNetworkSubnetState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as PubicCloudPrivateNetworkSubnetState | undefined;
            ...
            const args = argsOrState as PubicCloudPrivateNetworkSubnetArgs | undefined;
        ...
        super(PubicCloudPrivateNetworkSubnet.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface PubicCloudPrivateNetworkSubnetState {
    /**
     * Ip Block representing the subnet cidr.
     */
     ...
     * * `ip_pools/start` - First ip for this region.
     */
    ipPools?: pulumi.Input<pulumi.Input<inputs.PubicCloudPrivateNetworkSubnetIpPool>[]>;
    /**
     * Global network in CIDR format.
     * Changing this value recreates the subnet
     */
 ...
 */
export interface PubicCloudPrivateNetworkSubnetArgs {
    /**
     * Enable DHCP.
     * Changing this forces a new resource to be created. Defaults to false.
     * _
