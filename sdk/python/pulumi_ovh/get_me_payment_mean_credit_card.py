...
__all__ = [
    ...
    'get_me_payment_mean_credit_card',
    'get_me_payment_mean_credit_card_output',
]
...
def get_me_payment_mean_credit_card(description_regexp: Optional[str] = None,
...
@_utilities.lift_output_func(get_me_payment_mean_credit_card)
def get_me_payment_mean_credit_card_output(description_regexp: Optional[pulumi.Input[Optional[str]]] = None,
