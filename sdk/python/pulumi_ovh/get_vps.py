...
class GetVPSResult:
    ...
    """
    def __init__(__self__, cluster=None, datacenters=None, displayname=None, id=None, ips=None, keymap=None, memory=None, models=None, name=None, netbootmode=None, offertype=None, service_name=None, slamonitoring=None, state=None, type=None, vcore=None, zone=None):
    ...
    @property
    @pulumi.getter
    def datacenters(self) -> Sequence['outputs.GetVPSDatacenterResult']:
        """
    ...
    @property
    @pulumi.getter
    def models(self) -> Sequence['outputs.GetVPSModelResult']:
        """
