...
__all__ = [
    'GetIPLoadbalancingVRACNetworkResult',
    'AwaitableGetIPLoadbalancingVRACNetworkResult',
    'get_ip_loadbalancing_vrac_network',
    'get_ip_loadbalancing_vrac_network_output',
]

@pulumi.output_type
class GetIPLoadbalancingVRACNetworkResult:
    """
...
class AwaitableGetIPLoadbalancingVRACNetworkResult(GetIPLoadbalancingVRACNetworkResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetIPLoadbalancingVRACNetworkResult(
...
def get_ip_loadbalancing_vrac_network(service_name: Optional[str] = None,
                                      vrack_network_id: Optional[int] = None,
                                      opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetIPLoadbalancingVRACNetworkResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('ovh:index/getIPLoadbalancingVRACNetwork:getIPLoadbalancingVRACNetwork', __args__, opts=opts, typ=GetIPLoadbalancingVRACNetworkResult).value

    return AwaitableGetIPLoadbalancingVRACNetworkResult(
...
@_utilities.lift_output_func(get_ip_loadbalancing_vrac_network)
def get_ip_loadbalancing_vrac_network_output(service_name: Optional[pulumi.Input[str]] = None,
                                             vrack_network_id: Optional[pulumi.Input[int]] = None,
                                             opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetIPLoadbalancingVRACNetworkResult]:
    """
    Use this data source to get the details of Vrack network available for your IPLoadbalancer associated with your OVH account.
