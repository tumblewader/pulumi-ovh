...
__all__ = ['VRACIPLoadbalancingArgs', 'VRACIPLoadbalancing']

@pulumi.input_type
class VRACIPLoadbalancingArgs:
...
@pulumi.input_type
class _VRACIPLoadbalancingState:
    def __init__(__self__, *,
...
class VRACIPLoadbalancing(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param VRACIPLoadbalancingArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(VRACIPLoadbalancingArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = VRACIPLoadbalancingArgs.__new__(VRACIPLoadbalancingArgs)
        ...
        super(VRACIPLoadbalancing, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            ip_loadbalancing: Optional[pulumi.Input[str]] = None,
            service_name: Optional[pulumi.Input[str]] = None) -> 'VRACIPLoadbalancing':
        """
        ...
        __props__ = _VRACIPLoadbalancingState.__new__(_VRACIPLoadbalancingState)

        __props__.__dict__["ip_loadbalancing"] = ip_loadbalancing
        __props__.__dict__["service_name"] = service_name
        return VRACIPLoadbalancing(resource_name, opts=opts, __props__=__props__)
