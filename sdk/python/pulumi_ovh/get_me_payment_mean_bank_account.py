...
__all__ = [
    ...
    'get_me_payment_mean_bank_account',
    'get_me_payment_mean_bank_account_output',
]
...
def get_me_payment_mean_bank_account(description_regexp: Optional[str] = None,
...
@_utilities.lift_output_func(get_me_payment_mean_bank_account)
def get_me_payment_mean_bank_account_output(description_regexp: Optional[pulumi.Input[Optional[str]]] = None,
