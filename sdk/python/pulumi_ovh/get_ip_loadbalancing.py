...
__all__ = [
    ...
    'get_ip_loadbalancing',
    'get_ip_loadbalancing_output',
]
...
def get_ip_loadbalancing(display_name: Optional[str] = None,
...
@_utilities.lift_output_func(get_ip_loadbalancing)
def get_ip_loadbalancing_output(display_name: Optional[pulumi.Input[Optional[str]]] = None,
